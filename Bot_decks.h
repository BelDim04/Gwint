...
class Bot_deck_src {
public:
    std::vector<std::shared_ptr<Card>> deck_weak;
    std::vector<std::shared_ptr<Card>> deck_normal;
    std::vector<std::shared_ptr<Card>> deck_hard;
    std::vector<std::shared_ptr<Card>> empty;
    //std::vector<std::shared_ptr<Card>> deck_7;
